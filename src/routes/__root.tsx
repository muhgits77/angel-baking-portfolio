  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-3 text-muted-foreground">This page is out of the oven and gone.</p>
        <Link
          to="/"
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-2xl font-serif text-foreground">Something didn't load</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Handcrafted artisan breads, cakes, donuts, bagels and pastries baked with love by Angel in Monticello, Kentucky." },
      { name: "author", content: "Angel" },
      { property: "og:title", content: "Angel • Artisan Baker" },
      { property: "og:description", content: "Handcrafted breads, cakes, donuts, bagels and pastries baked with love." },
